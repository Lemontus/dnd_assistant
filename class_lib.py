...
hpotion = Potion("Healing Potion", "a bottle of red liquid", 12, lleafp.name, lleafp.name, lleafp.name, rherbp.name, rherbp.name, f"{lleaf.id}{lleaf.id}{lleafp.id}{rherbp.id}{rherbp.id}")
